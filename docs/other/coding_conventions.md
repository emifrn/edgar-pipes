...
@Claude, I may revisit the naming convention at the end when all functions have been stabilized.

## Function Naming Conventions

Use consistent verbs that communicate both **cost** and **behavior** of operations:
...
Use fully qualified imports for **all local modules** to maintain clarity and avoid naming conflicts:
...
The `result` module is treated as a **language extension** due to frequent usage throughout the codebase and it is the only exception to fully qualified imports
